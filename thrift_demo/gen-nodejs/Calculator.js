...
Calculator_getUserById_args = function(args) {
  this.id = null;
  if (args) {
...
Calculator_getUserById_args.prototype = {};
Calculator_getUserById_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
Calculator_getUserById_args.prototype.write = function(output) {
  output.writeStructBegin('Calculator_getUserById_args');
...
Calculator_getUserById_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined) {
      this.success = args.success;
...
Calculator_getUserById_result.prototype = {};
Calculator_getUserById_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
Calculator_getUserById_result.prototype.write = function(output) {
  output.writeStructBegin('Calculator_getUserById_result');
  if (this.success !== null && this.success !== undefined) {
...
CalculatorClient.prototype.getUserById = function(id, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
...
CalculatorClient.prototype.send_getUserById = function(id) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('getUserById', Thrift.MessageType.CALL, this.seqid());
  var args = new Calculator_getUserById_args();
  args.id = id;
  args.write(output);
  output.writeMessageEnd();
  return this.output.flush();
...
CalculatorClient.prototype.recv_getUserById = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new Calculator_getUserById_result();
  result.read(input);
  input.readMessageEnd();
  ...
  if (this._handler.ping.length === 0) {
    Q.fcall(this._handler.ping)
      .then(function(result) {
        ...
        var result = new Calculator_ping_result(err);
        output.writeMessageBegin("ping", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
  ...
  if (this._handler.add.length === 2) {
    Q.fcall(this._handler.add, args.num1, args.num2)
      .then(function(result) {
        ...
        var result = new Calculator_add_result(err);
        output.writeMessageBegin("add", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
...
CalculatorProcessor.prototype.process_getUserById = function(seqid, input, output) {
  var args = new Calculator_getUserById_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.getUserById.length === 1) {
    Q.fcall(this._handler.getUserById, args.id)
      .then(function(result) {
        var result = new Calculator_getUserById_result({success: result});
        output.writeMessageBegin("getUserById", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new Calculator_getUserById_result(err);
        output.writeMessageBegin("getUserById", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.getUserById(args.id,  function (err, result) {
      var result = new Calculator_getUserById_result((err != null ? err : {success: result}));
      output.writeMessageBegin("getUserById", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
